...
- (id)initWithFrame:(CGRect)frame {
	...
	if (self) {
		...
		self.opacity = 0.8f;
		self.labelFont = Questrial_Regular(kLabelFontSize);
		self.detailsLabelFont = Questrial_Regular(kDetailsLabelFontSize);
		self.xOffset = 0.0f;
		self.yOffset = 0.0f;
...
- (void)layoutSubviews {
    ...
    NSDictionary *attributesDictionary = [NSDictionary dictionaryWithObjectsAndKeys:
                                         ...
                                         nil];
    CGRect frame = [detailsLabel.text boundingRectWithSize:maxSize
                                            options:NSStringDrawingUsesLineFragmentOrigin
                                         attributes:attributesDictionary
                                            context:nil];
    
    CGSize detailsLabelSize = frame.size;
